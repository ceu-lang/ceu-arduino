...
I would have liked to finish all the games, as scheduled origianally. However, this couldn't be achieved because of reasons like my unexpected unavailability for about a week, getting the frogger program to perfection taking long etc. Going forward, I would like to develop the invaders and the manic miner program as well in my free time. I would also like to develop other simple games like ultimate tic-tac-toe and 2048 for Céu in the Gameduino platform as well as the SDL platform. I would also love to do all possible contributions from my part to the Céu/Lua community.
